...
// Versión inline para texto corrido: "Cuesta UC 25/mes"
export function UCoinInline({ amount }: { amount: number }) {
  if (amount === 0) return <span className="text-emerald-600 font-bold">Gratis</span>;
  return (
    <span className="inline-flex items-center gap-1">
      <span className="w-4 h-4 rounded-full text-white text-[7px] font-black flex items-center justify-center" style={{ backgroundColor: "#577a2c" }}>
        UnitCoin
      </span>
